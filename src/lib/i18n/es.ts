...
export const es = {
	...
	proj_collections_count: (n: number) => (n === 1 ? '1 colección' : `${n} colecciones`),
	...
	proj_move_label: 'MOVER COLECCIONES A OTRO PROYECTO (OPCIONAL)',
	proj_move_none: '— Eliminar sin mover —',
	proj_move_hint: (n: number) =>
		n === 1
			? 'La colección se moverá antes de eliminar el proyecto.'
			: `Las ${n} colecciones se moverán antes de eliminar el proyecto.`,
	...
	// ── Detalle de proyecto (colecciones) ────────────────────────────────────
	pd_subtitle: 'Gestión de colecciones del proyecto',
	pd_new_collection: 'Nueva colección',
	pd_back: 'Volver a Proyectos',
	pd_kpi_total_images: 'Total imágenes',
	pd_members: 'Colaboradores',
	pd_loading: 'Cargando colecciones…',
	pd_empty_search: 'Sin resultados',
	pd_empty: 'No hay colecciones aún',
	pd_create_first: 'Crear primera colección',
	pd_col_collection: 'Colección',
	pd_col_images: 'Núm. Imágenes',
	pd_col_date: 'Fecha',
	pd_status_active: 'Activa',
	pd_status_completed: 'Completada',
	pd_modal_edit_title: 'Editar Colección',
	pd_modal_create_title: 'Nueva Colección',
	...
	pd_err_create_collection: (msg: string) => `No se pudo crear la colección: ${msg}`,
	pd_err_delete_collection: (msg: string) => `No se pudo eliminar la colección: ${msg}`,
	...
	pd_delete_collection_title: 'Eliminar colección',
	pd_delete_loading: 'Cargando información…',
	pd_col_not_empty: 'Esta colección no está vacía',
	...
	pd_move_hint_selected: 'Los registros se moverán a la colección seleccionada antes de eliminar.',
	pd_delete_confirm_pre: '¿Estás seguro de que quieres eliminar la colección ',

	// ── Espacio de trabajo de colección (revisión) ───────────────────────────
	...
	col_collection_id: 'ID de colección',
	col_collection_id_ph: 'id_coleccion',
	...
	col_empty_collection: 'Sin imágenes en esta colección',
