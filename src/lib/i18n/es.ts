...
export const es = {
	...
	dash_subtitle_reviewer: 'Panel de revisión — Unidades documentales pendientes de revisión',
	...
	dash_kpi_collections: 'Unidades documentales',
	...
	log_collection_prefix: 'Unidad documental ',
	...
	proj_collections_count: (n: number) => (n === 1 ? '1 unidad documental' : `${n} unidades documentales`),
	...
	proj_move_label: 'MOVER UNIDADES DOCUMENTALES A OTRO PROYECTO (OPCIONAL)',
	proj_move_none: '— Eliminar sin mover —',
	proj_move_hint: (n: number) =>
		n === 1
			? 'La unidad documental se moverá antes de eliminar el proyecto.'
			: `Las ${n} unidades documentales se moverán antes de eliminar el proyecto.`,
	...
	// ── Detalle de proyecto (unidades documentales) ──────────────────────────
	pd_subtitle: 'Gestión de unidades documentales del proyecto',
	pd_new_collection: 'Nueva unidad documental',
	pd_back: 'Volver a Proyectos',
	pd_kpi_total_images: 'Total imágenes',
	pd_members: 'Colaboradores',
	pd_loading: 'Cargando unidades documentales…',
	pd_empty_search: 'Sin resultados',
	pd_empty: 'No hay unidades documentales aún',
	pd_create_first: 'Crear primera unidad documental',
	pd_col_collection: 'Unidad documental',
	pd_col_images: 'Núm. Imágenes',
	pd_col_date: 'Fecha',
	pd_status_active: 'Activa',
	pd_status_completed: 'Completada',
	pd_modal_edit_title: 'Editar Unidad Documental',
	pd_modal_create_title: 'Nueva Unidad Documental',
	...
	pd_create_btn: 'Crear Unidad Documental',
	pd_val_start_date:
	...
	pd_err_create_collection: (msg: string) => `No se pudo crear la unidad documental: ${msg}`,
	pd_err_delete_collection: (msg: string) => `No se pudo eliminar la unidad documental: ${msg}`,
	...
	pd_delete_collection_title: 'Eliminar unidad documental',
	pd_delete_loading: 'Cargando información…',
	pd_col_not_empty: 'Esta unidad documental no está vacía',
	...
	pd_move_hint_selected: 'Los registros se moverán a la unidad documental seleccionada antes de eliminar.',
	pd_delete_confirm_pre: '¿Estás seguro de que quieres eliminar la unidad documental ',

	// ── Espacio de trabajo de unidad documental (revisión) ───────────────────
	...
	col_rename_modal_title: 'Renombrar imágenes',
	col_rename_desc: 'Todas las imágenes se renombrarán usando el patrón:',
	col_collection_id: 'ID de unidad documental',
	col_collection_id_ph: 'id_unidad_documental',
	...
	col_empty_collection: 'Sin imágenes en esta unidad documental',
